                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone') }}" name="phone" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" onclick="showPassword2()"> {{ translate(' Show Password') }}
                                            <div id="msg"></div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="aiz-checkbox">
                                                ...
                                                <span class=opacity-60>{{ translate('تم الاطلاع على سياسة البيع والاسترداد الخاصة بالموقع')}}</span>
