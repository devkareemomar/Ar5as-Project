...
@php
        $categories = \App\Category::where([['level', 0],['published', 1]])->orderBy('name', 'asc')->get();
     ...
     <div class="page-content">
        <div class="container">
            ...
            <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs"
                style="background-image: url('{{ uploaded_asset(get_setting('bunner_all_cat')) }}'); background-color: #FFC74E;">
                <div class="banner-content">
                    <h4 class="banner-subtitle font-weight-bold">{{ translate('Accessories Collection') }}</h4>
                    <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-normal">{{ translate('Smart Wrist Watches') }}
                        </h3>
                    <a href="" class="btn btn-dark btn-rounded btn-icon-right">{{ translate('Discover Now') }}
            ...
            <div class="shop-default-category category-ellipse-section mb-6">
                <div class="swiper-container swiper-theme shadow-swiper"
                    ...
                    <div class="swiper-wrapper row gutter-lg cols-xl-8 cols-lg-7 cols-md-6 cols-sm-4 cols-xs-3 cols-2" style="height: auto; margin-right: 25%;">
                            ...
                            <div class="category category-ellipse">
                                <figure class="category-media">
                                    <a href="{{ route('products.category', $category->slug) }}">
                                        <img src="{{ uploaded_asset($category->banner) }}" alt="Categroy"
                                            style="width:129px; height:129px;" style="background-color: #5C92C0;" />
                                    </a>
                                </figure>
            ...
            <div class="shop-content row gutter-lg mb-10">
                ...
                <form class="" id="search-form" action="{{ route('search') }}" method="GET">
                    <input type="hidden" name="all_cat" value="1">
                    <!-- Start of Shop Content -->
                    <div class="shop-content row gutter-lg mb-10">
