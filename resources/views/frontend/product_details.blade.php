                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                   <form class="">
                                       <p id="shipping_days" class="text-center"> يتم التوصيل الي القاهرة خلال 6 ايام  </p>
                                       <select id="cities" class="form-control">
                                           @foreach ($cities as $city)
                                               <option class="form-control" value="{{ $city->id }}"> {{ $city->getTranslation('name') }} </option>
                                           @endforeach
                                       </select>
                                   </form>
                                </div>
                            ...
                            @else
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="">
                                            <strong class="h2 fw-600 text-primary">
                                                {{ defulat_price($detailedProduct->id) }}
                                            </strong>
                                            @if($detailedProduct->unit != null)
                                                <span class="opacity-70">/{{ $detailedProduct->getTranslation('unit') }}</span>
                                            @endif
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <div class="mt-2">
                                                <span class="fs-17 fw-600 text-primary">{{ defulat_price($top_product->id) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    ...
                                    <hr>
                                        ...
                                        @if ($detailedProduct->length)
                                          <p> <span> length : </span> <strong> {{ $detailedProduct->length }} </strong> </p>
                                         <hr>
                                        @endif
                                         @if ($detailedProduct->height)
                                            <p> <span> height : </span> <strong> {{ $detailedProduct->height }} </strong></p>
                                         <hr>
                                        @endif
                                         @if ($detailedProduct->width)
                                           <p> <span> width  : </span> <strong>  {{ $detailedProduct->width }} </strong></p>
                                         <hr>
                                        @endif
                                         @if ($detailedProduct->length)
                                              <p> <span> weight : </span> <strong> {{ $detailedProduct->length }} </strong></p>
                                        @endif
                                    ...
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            <div class="fs-15">
                                                ...
                                                @endif  --}}
                                                <span class="fw-700 text-primary">{{ defulat_price($related_product->id) }}</span>
                                            </div>
                                            <div class="rating rating-sm mt-1">
