...
.mynewnav li:hover ul.dropdown{
    display: block;	/* Display the dropdown */
}
.mynewnav li ul.dropdown li{
    display: block;
...
<div class="bg-move py-1 nav-mobile-hiddin" style="height: 40px">
    <ul class="mynewnav">
        <li><a href="{{ route('home') }}">{{ translate('الرئيسية') }}</a></li>
        @php 
        ...
        <li>
            ...
            <ul class="dropdown"  style="padding: 20px;max-width: 350px;max-height:400px;overflow-y: auto; margin:0 auto;">
