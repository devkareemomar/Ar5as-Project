                        ...
                        <div class="p-3">
                             <div class="form-group">
                               <div class="form-check">
                                    ...
                                    @php 
                                    $contract = "http://" . $_SERVER['SERVER_NAME'] .'/ar5as/ar5as/public/ar5as_seller_contract.docx';
                                    @endphp
                                    <label class="form-check-label" for="exampleCheck1">{{ translate('I agree to the contract')}} <a href="{{ asset('/sellerpolicy') }}" target="blank" >{{ translate('السياسات العامه للبيع')}} </a> , <a href="{{ $contract }}" target="blank" >{{ translate('Read the contract')}} </a>  </label>
                                </div>
                            </div>
                        </div>
                    </div>
