                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="pl-4">
                            <h1 class="fw-600 h4 mb-0">{{ $shop->name }}
                                @if ( isset( $shop->user->seller) && $shop->user->seller->verification_status == 1)
            ...
            <div class="row">
                <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                    <div class="bg-white rounded shadow-sm p-4 text-center">
                        <h3 class="fw-600 h4">
                            {{(isset($seller->user->name)) ? $seller->user->name : ''}} {{ translate('has not been verified yet.')}}
                        </h3>
                    </div>
                </div>
            </div>
