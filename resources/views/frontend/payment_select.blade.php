            ...
            <div class="row">
                <div class="col-lg-8">
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card shadow-sm border-0 rounded">
                            ...
                            <div class="card-body text-center">
                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                            ...
                                            @if(\App\Addon::where('unique_identifier', 'african_pg')->first() != null && \App\Addon::where('unique_identifier', 'african_pg')->first()->activated)
                                                ...
                                                @endif
                                            @endif
                                            @if(\App\BusinessSetting::where('type', 'visa_master')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                ...
                                @php
                                    ...
                                    $totalForWelt =    $total+shippingCostByCityId($shipping_info['city']);
                                ...
                                @if (Auth::check() && \App\BusinessSetting::where('type', 'wallet_system')->first()->value == 1)
                                    ...
                                    <div class="text-center py-4">
                                        ...
                                        @if(Auth::user()->balance < $totalForWelt)
                        ...
                        <div class="pt-3" style="font-size: 20px">
                            <label class="aiz-checkbox" style="font-size: 20px">
                        ...
                        <div class="row align-items-center pt-3">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" id="submitOrderCheckout"
...
@section('script')
    <script type="text/javascript">
        ...
        function submitOrderAction(event) {
            ...
            var paymentMethods = ['visa_master', 'meeza_card', 'mobile_wallet'];
            var chosenPaymentMethod = document.querySelector(".online_payment:checked").value;

            if ($('#agree_checkbox').is(":checked")) {

                if (paymentMethods.includes(chosenPaymentMethod)) {
                    ...
                    var request = $.ajax({
                        ...
                        data: {
                            _token: "{{csrf_token()}}",
                            payment_option: chosenPaymentMethod
                        }
                    });
        ...
        document.getElementById('submitOrderCheckout').addEventListener('click', submitOrderAction);
