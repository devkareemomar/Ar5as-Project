        ...
        <div class="container-fluid">
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                      @php 
                         $virified = App\Seller::where('user_id', Auth::user()->id)->select('verification_status')->first();
                        @endphp 
                            ...
                            <table class="table aiz-table mb-0"> 
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%">{{ translate('صورة المنتج')}}</th>
                                        <th width="25%">{{ translate('Product Alert Quantaty')}}</th>
                                        <th data-breakpoints="md">{{ translate('Category')}}</th>
                                        <th data-breakpoints="md">{{ translate('Current Qty')}}</th>
                                        <th>{{ translate('Base Price')}}</th>
                                        <th data-breakpoints="md">{{ translate('Published')}}</th>
                                        <th data-breakpoints="md">{{ translate('Featured')}}</th>
                                        <th data-breakpoints="md">{{ translate('Admin Approval')}}</th>
