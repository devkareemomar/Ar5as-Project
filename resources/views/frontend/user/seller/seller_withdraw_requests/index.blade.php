                        ...
                        <div class="col-md-3 mb-3 ml-auto" >
                            <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                              ...
                              <div class="px-3 pt-3 pb-3">
                                @php
                                $orderDetails = \App\OrderDetail::where('seller_id', Auth::user()->id)->where('is_refunded',0)->get();
                                $total = 0;
                            ...
                            @endphp
                                  <div class="h4 fw-700 text-center">{{ single_price($total) }}</div>
                                  <div class="opacity-50 text-center">{{ translate('Total Sold') }}</div>
                              </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="request_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                @if (Auth::user()->seller->available_balance > 5)
                    <form class="" action="{{ route('withdraw_requests.store') }}" method="post">
                        ...
                        <div class="modal-body gry-bg px-3 pt-3">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" lang="en" class="form-control mb-3" name="amount" min="1" max="{{ Auth::user()->seller->available_balance }}" placeholder="{{ translate('Amount') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
