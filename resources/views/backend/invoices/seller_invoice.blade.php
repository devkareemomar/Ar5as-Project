	    ...
	    <div style="padding: 1rem;">
			<table class="padding text-left small border-bottom">
				...
				<tbody class="strong">
	                ...
	                @foreach ($order->orderDetails->where('is_deleted', '=', 0)->where('seller_id' , $seller ) as $key => $orderDetail)
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        <tr>
			            ...
			            <td class="currency">{{ single_price($order->orderDetails->where('is_deleted', '=', 0)->where('seller_id' , $seller )->sum('price')) }}</td>
			        </tr>
			        <tr>
			            <th class="gry-color text-left">{{ translate('Shipping Cost') }}</th>
			            <td class="currency">{{ single_price($order->orderDetails->where('is_deleted', '=', 0)->where('seller_id' , $seller )->sum('shipping_cost')) }}</td>
			        </tr>
			        <tr class="border-bottom">
			            <th class="gry-color text-left">{{ translate('Total Tax') }}</th>
			            <td class="currency">{{ single_price($order->orderDetails->where('is_deleted', '=', 0)->where('seller_id' , $seller )->sum('tax')) }}</td>
			        </tr>
                    <tr class="border-bottom">
