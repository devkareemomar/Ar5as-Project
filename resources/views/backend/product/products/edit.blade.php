		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control aiz-date-range" value="{{ $discount_from.' to '.$discount_to }}" name="date_range" placeholder="Select Date" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                    </div>
				...
				<div class="form-group row" id="quantity">
					<label class="col-lg-3 col-from-label">{{translate('Quantity')}}</label>
					<div class="col-lg-6">
						<input type="number" lang="en" value="{{ $product->alert_qty }}" step="1" placeholder="{{translate('Quantity')}}" name="alert_qty" class="form-control" required>
					</div>
				</div>
				<br>
