	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<td class="text-center">
					<label for="" class="control-label">{{translate('Alert Quantity')}}</label>
				</td>
				<td></td>
			</tr>
		</thead>
...
@foreach ($combinations as $key => $combination)
	...
	@if(strlen($str) > 0)
			<tr class="variant">
				...
				<td>
					<input type="text" lang="en" name="price_{{ $str }}" value="{{ $unit_price }}" min="0" step="0.01" class="form-control" required>
				</td>
				<td>
					<input type="text" name="sku_{{ $str }}" value="" class="form-control">
				</td>
				<td>
					<input type="text" lang="en" name="qty_{{ $str }}" value="0" min="0" step="1" class="form-control" required>
				</td>
				<td>
					<input type="text" lang="en" name="alert_qty_{{ $str }}" value="0" min="0" step="1" class="form-control" required>
				</td>
				<td>
