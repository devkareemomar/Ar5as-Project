...
@section('content')
    ...
    <div class="row">
    	<div class="col-lg-8 mx-auto">
            ...
            <div class="card">
    			<div class="card-header">
    				<h6 class="fw-600 mb-0">{{ translate('Bunner All  Category') }}</h6>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					@csrf
    					...
    					<div class="form-group row">
    						<label class="col-md-3 col-from-label">{{ translate('Bunner') }}</label>
                            <div class="col-md-8">
        						<div class="input-group " data-toggle="aizuploader" data-type="image">
        							<div class="input-group-prepend">
        								<div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
        							...
        							<div class="form-control file-amount">{{ translate('Choose File') }}</div>
        							<input type="hidden" name="types[]" value="bunner_all_cat">
        							<input type="hidden" name="bunner_all_cat" value="{{ get_setting('bunner_all_cat') }}" class="selected-files">
        						</div>
        						<div class="file-preview box"></div>
                            </div>
    					</div>
