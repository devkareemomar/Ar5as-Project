...
<body class="">
	...
	<script type="text/javascript" src="{{ static_asset('assets/js/plugins/jquery.dataTables.min.js') }}"></script>
    <script type="text/javascript" src="{{ static_asset('assets/js/plugins/dataTables.bootstrap.min.js') }}"></script>
