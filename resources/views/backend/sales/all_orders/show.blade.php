        ...
        <div class="card-header">
          <h1 class="h2">{{ translate('Order Details') }}
            <small>
                ...
                {{ translate('Tracking Screen') }}
                @elseif ($order->order_status == 'picked' || $order->order_status == 'on_delivery')
                 {{ translate('Shipping Screen') }}
                @elseif ($order->order_status == 'delivered' )
                  {{ translate('Completed Order') }}
                @else
        ...
        <div>
            <div class="py-4">
                <div class="row gutters-5 text-center aiz-steps">
                    ...
                    {{-- <div class="col @if($order->order_status == 'picked') active @elseif($order->order_status == 'on_delivery' || $order->order_status == 'delivered' || $order->order_status == 'confirmed') done @endif">
                        <div class="icon">
                            <i class="las la-newspaper"></i>
                        </div>
                    <div class="title fs-12">{{ translate('Picked UP')}}</div>
  			...
  			<div class="col-md-3 ml-auto">
                  ...
                  <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                     @if ($order->order_status == 'pending' || $order->order_status == 'confirmed')
                      ...
                      @endif
                      @if ($order->order_status == 'picked' || $order->order_status == 'on_delivery')
