      ...
      <form class="" action="" method="GET">
        <div class="card-header row gutters-5">
          <div class="col text-center text-md-left">
            <h5 class="mb-md-0 h6">{{ translate('All Orders Tracking') }}</h5>
          </div>
          <div class="col-lg-2">
            ...
            <tbody>
                @foreach ($orders as $key => $order)
                    <tr>
                        ...
                        <td class="text-right">
                           @if($status != 'cancelled')
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('tracking.all_orders.show', encrypt($order->id))}}" title="{{ translate('View') }}">
