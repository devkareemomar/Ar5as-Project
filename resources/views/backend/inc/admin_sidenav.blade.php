            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{route('subcategories.all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['subcategories.all', 'subcategories.create', 'subcategories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Sub Category')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('subsubcategories.all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['subsubcategories.all', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('tracking.all_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['tracking.all_orders.index', 'tracking.all_orders.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Tracking Orders')}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('shipping.all_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping.all_orders.index', 'shipping.all_orders.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Shipping Orders')}}</span>
                                </a>
                            </li>
                        @endif
                         ...
                         {{--  @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('complete.all_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['complete.all_orders.index', 'complete.all_orders.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Complete Orders')}}</span>
                                </a>
                            </li>
                        @endif  --}}
                ...
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.seller.account.statment') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('seller Account Statment') }}</span>
                                </a>
                            </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('activitylog.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['in_house_sale_report.index'])}}">
