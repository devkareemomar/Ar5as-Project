        ...
        if ($.fn.countdown) {
            Wolmart.$(selector).each(function() {
                var $this = $(this),
                    ...
                    newLabels = (!$this.data('labels-short')) ? ['Years', 'Months', 'Weeks', 'Days', 'Hours', 'Minutes', 'Seconds'] : ['Years', 'Months', 'Weeks', 'Days', 'Hrs', 'Mins', 'Secs'],
...
(function($) {
    ...
    var initProductCartAction = function() {
        ...
        Wolmart.$body.on('click', selector, function(e) {
            ...
            setTimeout(function() {
                ...
                var cartLink = $product.find('.product-action a').attr('cartLink');
                if (cartLink == undefined) {
                    var cartLink = $product.find('.product-cart a').attr('cartLink');
                    var checkoutLink = $product.find('.product-cart a').attr('checkoutLink');

                } else {
                    var cartLink = $product.find('.product-action a').attr('cartLink');
                    var checkoutLink = $product.find('.product-action a').attr('checkoutLink');
                ...
                Wolmart.Minipopup.open({
                    ...
                    actionTemplate: '<a href="' + cartLink + '" class="btn btn-rounded btn-sm">View Cart</a><a href="' + checkoutLink + '" class="btn btn-dark btn-rounded btn-sm">Checkout</a>'
                });
            }, 500);
        });
    }
    ...
    var initCompare = function() {
        ...
        function initComparePopup() {
            ...
            var baseurl = getUrl.origin + '/' + getUrl.pathname.split('/')[1] + '/compare';
            var compareHtml =
                '<div class="compare-popup">\
                    <div class="container">\
                        ...
                        <a href="#" class="btn btn-clean"></a>\
                        <a href="' + baseurl + '" class="btn btn-dark btn-rounded">Start Compare !</a>\
                    </div>\
                </div>\
