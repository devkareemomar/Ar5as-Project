...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::post('/categories/refund', 'CategoryController@updateRefund')->name('categories.refund');
	Route::post('/categories/published', 'CategoryController@updatePublished')->name('categories.published');

	/////////////////////////////////////////////////////////////////
	// sub category routes //
	Route::get('/subcategories/all', 'CategoryController@allSubCategories')->name('subcategories.all');
	Route::get('/subcategories/create', 'CategoryController@createSubCategory')->name('subcategories.create');
	Route::get('/subcategories/edit/{id}', 'CategoryController@editSubCategory')->name('subcategories.edit');
	Route::post('/subcategories/store', 'CategoryController@storeSubCategory')->name('subcategories.store');
	Route::post('/subcategories/update/{id}', 'CategoryController@updateSubCategory')->name('subcategories.update');
	Route::post('/subcategories/delete/{id}', 'CategoryController@deleteSubCategory')->name('subcategories.delete');
	// sub category routes //

	Route::get('/subsubcategories/all', 'CategoryController@allSubSubCategories')->name('subsubcategories.all');
	Route::get('/subsubcategories/create', 'CategoryController@createSubSubCategory')->name('subsubcategories.create');
	Route::get('/subsubcategories/edit/{id}', 'CategoryController@editSubSubCategory')->name('subsubcategories.edit');
	Route::post('/subsubcategories/store', 'CategoryController@storeSubSubCategory')->name('subsubcategories.store');
	Route::post('/subsubcategories/update/{id}', 'CategoryController@updateSubSubCategory')->name('subsubcategories.update');
	Route::post('/subsubcategories/delete/{id}', 'CategoryController@deleteSubSubCategory')->name('subsubcategories.delete');

	Route::get('/subcat','CategoryController@selectSupcat')->name('subcat');
	...
	Route::get('/products/alert/qty','ProductController@alertQty')->name('products.alertQty');
	...
	Route::post('/products/admin_approval', 'ProductController@adminApproval')->name('products.admin_approval');
	...
	Route::get('admin-sellers/account/statment', 'SellerController@AdminSellerAccountStatment')->name('admin.seller.account.statment');
	...
	Route::post('/order/atstock', 'OrderController@updateItemstatus')->name('order.atstock');
	// tracking  Orders
	Route::get('/tracking/all_orders', 'OrderController@tracking_all_orders')->name('tracking.all_orders.index');
	Route::get('/tracking/all_orders/{id}/show', 'OrderController@tracking_all_orders_show')->name('tracking.all_orders.show');

	// shipping Orders
	Route::get('/shipping/all_orders', 'OrderController@shipping_all_orders')->name('shipping.all_orders.index');
	Route::get('/shipping//all_orders/{id}/show', 'OrderController@shipping_all_orders_show')->name('shipping.all_orders.show');

	// shipping Orders
	Route::get('/complete/all_orders', 'OrderController@complete_all_orders')->name('complete.all_orders.index');
	...
	Route::get('/activitylog', 'ActivityLogController@show')->name('activitylog.index');
	Route::get('/activity_report', 'ActivityLogController@activity_report')->name('activity_report');
