...
Route::post('/home/section/maincategory', 'HomeController@maincategory')->name('home.section.maincategory');
// home.section.maincategory
...
Route::post('/home/search_seller', 'HomeController@search_seller')->name('search.seller');
Route::get('/home/All_sellers', 'HomeController@All_sellers')->name('home.All_sellers');
...
Route::get('/product/shipping', 'HomeController@sipingDays')->name('shippingDay');
...
Route::get('/subcatt','HomeController@selectSupcat2')->name('subcatt');
Route::get('/citeybygovs','HomeController@citeyByGov')->name('citeybygovs');
...
Route::post('/cart/removeFromCartView', 'CartController@removeFromCartView')->name('cart.removeFromCartView');
...
Route::get('/allseller', 'HomeController@allseller')->name('allseller');
...
Route::group(['middleware' => ['user', 'verified','unbanned']], function(){
	...
	Route::get('/seller/account-statment', 'HomeController@sellerAccountStatment')->name('seller.account.statment');
	...
	Route::post('/seller/update-payment', 'HomeController@seller_update_payment')->name('seller.update.payment');

	// alert qty
	Route::get('/seller/alert-qty', 'HomeController@getAlertQty')->name('seller.alertqty');
	//
...
Route::group(['prefix' =>'seller', 'middleware' => ['seller', 'verified', 'user']], function(){
	...
	Route::get('/products/alert/qty','HomeController@alertQtySeller')->name('seller.products.alertQty');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::get('invoice/seller/{order_id}/{seller?}', 'InvoiceController@seller_invoice_download')->name('seller.invoice.download');

	Route::resource('orders','OrderController');
	Route::get('/orders/destroy/{id}', 'OrderController@destroy')->name('orders.destroy');
	Route::get('/orders/cancell/{id}', 'OrderController@cancell_order')->name('orders.cancell');
	Route::get('/orders/seller/details/{id}', 'OrderController@seller_order_details')->name('orders.seller.detail');
	Route::post('/orders/details', 'OrderController@order_details')->name('orders.details');
	Route::post('/orders/update_delivery_status', 'OrderController@update_delivery_status')->name('orders.update_delivery_status');

	Route::post('/orders/update_refund_status', 'OrderController@update_refund_status')->name('orders.update_refund_status');
	Route::post('/orders/update_payment_status', 'OrderController@update_payment_status')->name('orders.update_payment_status');
	Route::post('/orders/recalculate_order', 'OrderController@recalculate_order')->name('orders.recalculate_order');
	Route::post('/orders/refund_item_from_order', 'OrderController@refundOrderItem')->name('orders.refund_orderitem');

	Route::post('/orders/update_shipping_status', 'OrderController@update_shipping_status')->name('orders.update_shipping_status');

	Route::post('/orders/available_yes', 'OrderController@available_yes')->name('orders.available_yes');
