...
<div class="card">
    ...
    <div class="card-body">
        <table class="table aiz-table" id="sampleTable">
            <thead>
                <tr>
                    <th>#</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($refund->refund_status == 2)
                                <span class="badge badge-inline badge-primary">{{translate('At Stock')}}</span>
                            @elseif($refund->refund_status == 3)
                                <span class="badge badge-inline badge-warning">{{translate('Product Checked')}}</span>
