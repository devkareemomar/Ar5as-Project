    		...
    		<div class="card">
    			...
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
    						<label for="name">{{translate('Arrival Days')}}</label>
    						<input type="number" min="0" step="0.01" placeholder="{{translate('Arrival Days')}}" name="arrival_days" class="form-control" required>
    					</div>
