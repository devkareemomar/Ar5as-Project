                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="password" id="Password" class="form-control" placeholder="{{ translate('New Password') }}" name="password">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="bank_name" class="js-example-basic-single form-control">
                                     <option>{{ translate('Select Bank Name')}} </option>
                                    <option value="bank_alhly" {{ Auth::user()->seller->bank_name == 'bank_alhly' ? 'selected' : '' }} >{{ translate('Bank Alhly')}} </option>
                                    <option value="bank_masr"  {{ Auth::user()->seller->bank_name == 'bank_masr' ? 'selected' : '' }}>{{ translate('Bank Masr')}}</option>
                                    <option value="bank_alex"  {{ Auth::user()->seller->bank_name == 'bank_alex' ? 'selected' : '' }}>{{ translate('Bank Alex')}}</option>
                                    <option value="bank_cip"   {{ Auth::user()->seller->bank_name == 'bank_cip' ? 'selected' : '' }}>{{ translate('Bank CIP')}}</option>
