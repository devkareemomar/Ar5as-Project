            ...
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    <li class="list-inline-item mr-0">
                        <a href="{{ route('home') }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            الرئيسية
                        </a>
                    </li>
                    {{--  <li class="list-inline-item mr-0">
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="{{ route('brands.all') }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                           العلامات التجارية 
                        </a>
                    </li>
