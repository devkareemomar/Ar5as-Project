                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <label class="custom-file-label">
                                        <input type="file" class="custom-file-input" name="national_id_photo" accept="">
                            ...
                            <div class="form-group company-data">
                                ...
                                <div class="custom-file">
                                    <label class="custom-file-label">
                                        <input type="file" class="custom-file-input" name="tax_photo" accept="">
                                        <span class="custom-file-name">{{ translate('Choose image') }}</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group company-data">
                                ...
                                <div class="custom-file">
                                    <label class="custom-file-label">
                                        <input type="file" class="custom-file-input" name="commercial_register_photo" accept="" >
                                        <span class="custom-file-name">{{ translate('Choose image') }}</span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="p-3">
                             <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">{{ translate('I agree to the contract')}} <a href="{{ asset('/sellerpolicy') }}" target="blank" >{{ translate('Read the contract')}} </a></label>
                                </div>
                            </div>
                        </div>
                    </div>
