    ...
    <div class="card-header">
        ...
        <div class="text-right">
            <span class="badge badge-inline badge-primary">
                {{--  {{ count(Session::get('cart')->where('owner_id', Session::get('owner_id'))) }} {{translate('Items')}}  --}}

                {{ count(Session::get('cart')) }} {{translate('Items')}}
            ...
            <tfoot>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right">
                        ...
                        @endphp
                            {{single_price( shippingCostByCityId($shipping_info['city']) )}}
                ...
                @php
                   // $total = $subtotal+$tax+$shipping;
                    $total =   $subtotal+$tax+shippingCostByCityId($shipping_info['city']);
                    if(Session::has('coupon_discount')){
                ...
                <tr class="cart-total">
                    ...
                    <td class="text-right">
                        {{--  <strong><span>{{ single_price($total) + single_price(shippingCostByCityId($shipping_info['city'])) }}</span></strong>  --}}
                         {{ single_price($total)}}
                    </td>
                </tr>
            </tfoot> 
