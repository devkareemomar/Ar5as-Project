...
@section('content')
    ...
    <div class="home-banner-area">
        <div class="">
            <div class="row gutters-10 position-relative">
                ...
                @php
                    $num_todays_deal = count(filter_products(\App\Product::where([['admin_approval', 1] ,['published', 1] ])->where('todays_deal', 1 ))->get());
                ...
                <div class="col-lg-2 order-3 mt-3 mt-lg-0">
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="c-scrollbar-light overflow-auto h-lg-400px p-2 bg-primary rounded-bottom">
                            ...
                            @foreach (filter_products(\App\Product::where([['admin_approval', 1] ,['published', 1] ])->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                <div class="col mb-2">
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                    @foreach ($flash_deal->flash_deal_products as $key => $flash_deal_product)
                        ...
                        @endphp
                        @if ($product != null && $product->published != 0 && $product->admin_approval == 1) 
                            <div class="carousel-box">
    ...
    @if(\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
        @php
            $customer_products = \App\CustomerProduct::where('status', '1')->where([['admin_approval', 1] ,['published', 1] ])->take(10)->get();
        @endphp
