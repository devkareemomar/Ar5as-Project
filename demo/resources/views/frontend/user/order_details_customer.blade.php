...
<div class="modal-body gry-bg px-3 pt-3">
    <div class="py-4">
        <div class="row gutters-5 text-center aiz-steps">
            ...
            <div class="col @if($status == 'picked') active @elseif($status == 'on_delivery' || $status == 'delivered') done @endif">
                <div class="icon">
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>
                            {{ single_price($order->orderDetails->where('is_deleted' , '=' , 0)->sum('price') + $order->orderDetails->where('is_deleted' , '=' , 0)->sum('tax')) }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($orderDetail->is_deleted == 0)
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="strong-600">{{ single_price($order->orderDetails->where('is_deleted' , '=' , 0)->sum('price')) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Shipping')}}</td>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->orderDetails->where('is_deleted' , '=' , 0)->sum('shipping_cost')) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Tax')}}</td>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->orderDetails->where('is_deleted' , '=' , 0)->sum('tax')) }}</span>
                                </td>
                            </tr>
                            <tr>
