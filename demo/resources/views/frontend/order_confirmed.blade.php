                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                {{--  {{ json_decode($order->shipping_address)->city }}, {{ json_decode($order->shipping_address)->country }}  --}}
                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $order->shipping_cost) }}</td>
                                            </tr>
                                            <tr>
