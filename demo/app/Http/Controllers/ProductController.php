...
class ProductController extends Controller
{
    ...
    {
        return view('backend.product.products.alert_qty');
    }
    ...
    public function store(Request $request)  
    {
      //  dd($request->all());
        ...
        if($request->category_id != null && $request->subcategory_id == null && $request->subsubcategory_id == null){
            //dd('category');
             $product->category_id   = $request->category_id;
        }
        elseif($request->subcategory_id != null && $request->subsubcategory_id == null ){
            //dd('sub category');
             $product->category_id   = $request->subcategory_id;
        }elseif($request->subsubcategory_id != null){
            // dd('sub subb category');
        ...
        $cat_refund = \App\Category::where('id', '=', $request->category_id )->first()->refundable;
            if($cat_refund == 1){
        ...
        // if($request->tax_type == 'include'){
        //     $product->tax = 0;
        //     $product->tax_type ='amount';
        // }elseif($request->tax_type == 'exclude'){
        //     $product->tax = 14;
        //     $product->tax_type ='percent';
        // }
        ...
        if($request->date_range != null){
            ...
            $product->discount_from = strtotime($date_var[0]);
            $product->discount_to   = strtotime( $date_var[1]);
        }
        ...
        if($request->hasFile('warranty')){
            $product->warranty = $request->warranty->store('uploads/products/pdf');
        }
        ...
        if(count($combinations[0]) > 0){
            ...
            foreach ($combinations as $key => $combination){
                ...
                $product_stock->alert_qty = $request['alert_qty_'.str_replace('.', '_', $str)];
            ...
            $product_stock->alert_qty = $request->alert_qty;
            $product_stock->seller_id = Auth::user()->id;
            $product_stock->save();
        }
        //combinations end
     ...
     public function adminApproval(Request $request)
    {
        ...
        $product->admin_approval = $request->status;
